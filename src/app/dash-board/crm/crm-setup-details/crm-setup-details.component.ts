...
@Component({
    selector: 'app-crm-setup-details',
    templateUrl: './crm-setup-details.component.html',
    styleUrls: ['./crm-setup-details.component.css'],
})
export class CrmSetupDetailsComponent implements OnInit {
    hexToRgb: any;
    rgbToHex: any;
    @Input() lang:any;
