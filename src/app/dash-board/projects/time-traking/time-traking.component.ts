...
@Component({
    selector: 'app-time-traking',
    templateUrl: './time-traking.component.html',
    styleUrls: ['./time-traking.component.css'],
})
export class TimeTrakingComponent implements OnInit {
    hexToRgb: any;
    rgbToHex: any;
    @Input() lang:any;
