...
@Component({
    selector: 'app-accounting-stmts',
    templateUrl: './accounting-stmts.component.html',
    styleUrls: ['./accounting-stmts.component.css'],
})
export class AccountingStmtsComponent implements OnInit {
    @Input() lang:any;
    hexToRgb: any;
    rgbToHex: any;
