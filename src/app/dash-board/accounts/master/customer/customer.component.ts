	...
	onDeleteButtonClick(params: any) {
		this.customerManager.customerdelete(params.data.id).subscribe((response) => {
			for (let i = 0; i < this.customer.length; i++) {
				if (this.customer[i].id == params.data.id) {
	...
	onOrderClick(event: any, customerForm: any) {
		...
		if (this.id) {
			...
			this.customerManager.customerupdate(customerdetails001mb).subscribe((response) => {
				...
				for (let customers of this.customer) {
					if (customers.id == customerdetails001mb.id) {
						customers.addressline1 = customerdetails001mb.addressline1;
						customers.addressline2 = customerdetails001mb.addressline2;
						customers.city = customerdetails001mb.city;
						customers.country = customerdetails001mb.country;
						customers.customergroup = customerdetails001mb.customergroup;
						customers.customername = customerdetails001mb.customername;
						customers.emailid = customerdetails001mb.emailid;
						customers.firstname = customerdetails001mb.firstname;
						customers.isprimaryaddress = customerdetails001mb.isprimaryaddress;
						customers.isprimarycontact = customerdetails001mb.isprimarycontact;
						customers.lastname = customerdetails001mb.lastname;
						customers.mobilenumber = customerdetails001mb.mobilenumber;
						customers.phone = customerdetails001mb.phone;
						customers.postalcode = customerdetails001mb.postalcode;
						customers.state = customerdetails001mb.state;
						customers.customerid = customerdetails001mb.customerid;
						customers.insertUser = this.insertUser;
						customers.insertDatetime = this.insertDatetime;
						customers.updatedUser = this.authManager.getcurrentUser.username;
						customers.updatedDatetime = new Date();
					}
				}
				this.gridOptions.api.setRowData(this.customer);
			...
			this.customerManager.customersave(customerdetails001mb).subscribe((response) => {
				...
				let customerdetails001mb = deserialize<Customerdetails001mb>(Customerdetails001mb, response);
				this.customer?.push(customerdetails001mb);
