...
@Component({
    selector: 'app-accountsrec-summary',
    templateUrl: './accountsrec-summary.component.html',
    styleUrls: ['./accountsrec-summary.component.css']
})

export class AccountsrecSummaryComponent implements OnInit {
    @Input() lang:any;
    ...
    constructor(private accountsReceivableManager: AccountsReceivableManager,
    ...
    ngOnInit() {
        ...
        this.accountsReceivableManager.allaccrec().subscribe(response => {
            this.accountsRec = deserialize<Accountsreceivable001mb[]>(Accountsreceivable001mb, response);
    ...
    onDeleteButtonClick(params: any) {
        this.accountsReceivableManager.accrecdelete(params.data.id).subscribe((response) => {
    ...
    onAuditButtonClick(params: any) {
        ...
        modalRef.componentInstance.title = "Account Receivable Summary";
    ...
    onOrderClick(event: any, accountsReceivable: any) {
        ...
        accountsreceivable001mb.currency = this.f.currency.value?this.f.currency.value:"";
        accountsreceivable001mb.customer = this.f.customer.value?this.f.customer.value:"";
        accountsreceivable001mb.duedate = new Date(this.f.duedate.value);
        accountsreceivable001mb.invoicedamount = this.f.invoicedamount.value?this.f.invoicedamount.value:0;
        accountsreceivable001mb.ninetyabove = this.f.ninetyabove.value?this.f.ninetyabove.value:0;
        accountsreceivable001mb.outstandingamount = this.f.outstandingamount.value ? this.f.outstandingamount.value : 0;
        accountsreceivable001mb.paidamount = this.f.paidamount.value?this.f.paidamount.value:0;
        accountsreceivable001mb.postingdate = new Date(this.f.postingdate.value);
        accountsreceivable001mb.remarks = this.f.remarks.value?this.f.remarks.value:"";
        accountsreceivable001mb.territory = this.f.territory.value?this.f.territory.value:"";
        accountsreceivable001mb.uptoninety = this.f.uptoninety.value?this.f.uptoninety.value:0;
        accountsreceivable001mb.uptosixty = this.f.uptosixty.value?this.f.uptosixty.value:0;
        accountsreceivable001mb.uptothirty = this.f.uptothirty.value? this.f.uptothirty.value:0;
        accountsreceivable001mb.voucherno = this.f.voucherno.value?this.f.voucherno.value:"";
        accountsreceivable001mb.vouchertype = this.f.vouchertype.value?this.f.vouchertype.value:"";
		if(this.id) {
            ...
            accountsreceivable001mb.updatedUser = this.authManager.getcurrentUser.username;
			accountsreceivable001mb.updatedDatetime = new Date();
            this.accountsReceivableManager.accrecupdate(accountsreceivable001mb).subscribe(response => {
                this.calloutService.showSuccess("Order Updated Successfully");
                let accrec = deserialize<Accountsreceivable001mb>(Accountsreceivable001mb, response);
				for(let accountsReceivables of this.accountsRec) {
					if(accountsReceivables.id ==accrec.id) {
                        ...
                        accountsReceivables.invoicedamount = accrec.invoicedamount;
                        accountsReceivables.postingdate = accrec.postingdate;
                        ...
                        accountsReceivables.vouchertype = accrec.vouchertype;
                        accountsReceivables.paidamount = accrec.paidamount;
                        accountsReceivables.outstandingamount = accrec.outstandingamount;
                        accountsReceivables.ninetyabove = accrec.ninetyabove;
                        accountsReceivables.insertUser = this.insertUser;
                        accountsReceivables.insertDatetime = this.insertDatetime;
                        accountsReceivables.updatedUser = this.authManager.getcurrentUser.username;
            ...
            accountsreceivable001mb.insertUser = this.authManager.getcurrentUser.username;
    ...
    onGeneratePdfReport() {
        this.accountsReceivableManager.accountsReceivablePdf().subscribe((response) => {
            saveAs(response, "AccountsReceivableSummaryList");
