...
@Component({
    selector: 'app-stock-reports-details',
    templateUrl: './stock-reports-details.component.html',
    styleUrls: ['./stock-reports-details.component.css'],
})
export class StockReportsDetailsComponent implements OnInit {
    @Input () lang: any;
    hexToRgb: any;
    rgbToHex: any;
