...
@Component({
    selector: 'app-stock-analytics-details',
    templateUrl: './stock-analytics-details.component.html',
    styleUrls: ['./stock-analytics-details.component.css'],
})
export class StockAnalyticsDetailsComponent implements OnInit {
    @Input() lang: any;
    hexToRgb: any;
    rgbToHex: any;
