...
@Component({
    selector: 'app-buying-report-details',
    templateUrl: './buying-report-details.component.html',
    styleUrls: ['./buying-report-details.component.css'],
})
export class BuyingReportDetailsComponent implements OnInit {
    hexToRgb: any;
    rgbToHex: any;
