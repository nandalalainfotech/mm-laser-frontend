...
@Component({
    selector: 'app-item-report-details',
    templateUrl: './item-report-details.component.html',
    styleUrls: ['./item-report-details.component.css'],
})
export class ItemReportDetailsComponent implements OnInit {
    hexToRgb: any;
    rgbToHex: any;
    @Input() lang:any;
