...
@Component({
    selector: 'app-customer-credit-balance',
    templateUrl: './customer-credit-balance.component.html',
    styleUrls: ['./customer-credit-balance.component.css']
})

export class CustomerCreditBalanceComponent implements OnInit {
    ...
    onGeneratePdfReport(){
		this.customerBalanceManager.customerBalancePdf().subscribe((response) =>{
            saveAs(response,"CustomerCreditBalanceList");
