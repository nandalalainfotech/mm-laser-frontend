...
@Component({
    selector: 'app-employee-report-details',
    templateUrl: './employee-report-details.component.html',
    styleUrls: ['./employee-report-details.component.css'],
})
export class EmployeeReportDetailsComponent implements OnInit {
    hexToRgb: any;
    rgbToHex: any;
