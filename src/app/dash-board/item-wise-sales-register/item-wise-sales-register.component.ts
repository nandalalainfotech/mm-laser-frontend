...
@Component({
    selector: 'app-item-wise-sales-register',
    templateUrl: './item-wise-sales-register.component.html',
    styleUrls: ['./item-wise-sales-register.component.css'],
})
export class ItemWiseSalesRegisterComponent implements OnInit {
